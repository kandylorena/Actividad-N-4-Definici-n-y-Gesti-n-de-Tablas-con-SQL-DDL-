...
2. Modificar tablas existentes:
    ...
    Al quere modificar el id por otro que ya existe generar error de duplicidad
    ...
    y si se hace cambio por un id que no exista aun si deja realizar el cambio, pero solo en esa si esa relacionado a otra tabla en la otra no cambia este.
